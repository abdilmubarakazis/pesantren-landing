...
type Slide = {
  ...
  subtitle: string;
  tokohImg?: string;
  tokohClass?: string; // ✅ NEW: atur posisi tokoh per slide
  buttons: {
    label: string;
    href: string;
...
export default function HeroSlider() {
    ...
    () => [
      {
        ...
        // ✅ TURUN + AGAK BESAR
        tokohClass:
          "translate-y-8 sm:translate-y-12 md:translate-y-6 scale-220 md:scale-150",
...

      {
        ...
        // kamu bisa atur per slide kalau perlu:
        // tokohClass: "translate-y-6 md:translate-y-10",
        buttons: [
  ...
  // animasi teks reset tiap slide berubah
  const [animKey, setAnimKey] = useState(0);
  useEffect(() => setAnimKey((k) => k + 1), [active]);

  // progress bar reset tiap slide berubah
  ...
  return (
    <section className="relative">
      ...
      >
        ...
        {/* Content */}
        <div className="container-page absolute inset-0 z-10 flex items-center py-6 md:py-0">
          <div className="grid w-full grid-cols-12 gap-4 items-center">
            {/* Tokoh */}
            <div className="col-span-12 md:col-span-4 flex justify-center md:justify-start order-1 md:order-none">
              {s.tokohImg ? (
                <div
                  className={[
                    "relative w-[140px] h-[160px] sm:w-[190px] sm:h-[210px] md:w-[240px] md:h-[270px]",
            ...
            >
              ...
              <h1 className="mx-auto md:mx-0 max-w-xl text-white text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight animate-hero-up [animation-delay:80ms]">
                {s.title}
              </h1>
              ...
              <div className="mt-4 flex flex-wrap gap-2 justify-center md:justify-start animate-hero-up [animation-delay:240ms]">
                {s.buttons.map((b, i) => (
                  <a
                    ...
                    href={b.href}
                    className={[
                      "rounded-full px-4 py-2 text-xs sm:text-sm font-bold transition",
                      b.variant === "primary" &&
              ...
              <div className="mt-5 flex flex-col items-center md:items-start gap-3 animate-hero-up [animation-delay:320ms]">
                ...
                {/* progress bar */}
                <div className="w-56 md:w-64 h-1.5 rounded-full bg-white/25 overflow-hidden">
                  <div
                    key={progressKey}
        ...
        {/* Klik area slider untuk next (opsional) */}
        <button
          type="button"
          aria-label="Next slide"
          onClick={() => {
